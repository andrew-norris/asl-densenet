...
if K.common.image_dim_ordering() == 'th':
  ...
  weights_path = 'E:/Workspace/asl-densenet/densenet_keras/imagenet_models/densenet161_weights_th.h5'
else:
  # Use pre-trained weights for Tensorflow backend
  weights_path = 'E:/Workspace/asl-densenet/densenet_keras/imagenet_models/densenet161_weights_tf.h5'
...
classes = []
with open('E:/Workspace/asl-densenet/densenet_keras/resources/classes.txt', 'r') as list_:
    for line in list_:
